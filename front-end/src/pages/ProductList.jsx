...
export function ProductList() {
    // 1. Definição dos Estados (O erro estava na falta disso)
        ...
        <div className="container mx-auto p-4 md:p-6 bg-white mt-4 shadow-sm border border-gray-200">
            ...
            <div className="flex justify-between items-end mb-4 border-b border-gray-200 pb-2">
                ...
                <input 
                    ...
                    className="border border-gray-400 p-1 rounded text-sm focus:ring-2 focus:ring-amazon-secondary focus:outline-none"
                    value={search} 
                            ...
                            return (
                                <tr key={product.id} className={`border-b border-gray-200 hover:bg-gray-50 ${isLowStock ? 'bg-red-50' : ''}`}>
                                    ...
                                    <td className="py-2 px-4 text-center">
                                        {isLowStock 
                                            ? <span className="text-red-600 font-bold text-xs">Apenas {product.quantity} em estoque</span>
                                    ...
                                    <td className="py-2 px-4 text-center space-x-2">
                                        ...
                                        <button 
                                            ...
                                            className="px-2 py-1 border border-gray-400 rounded bg-gray-100 text-xs hover:bg-gray-200 shadow-sm text-red-600"
                                        >
                                            Excluir
                                        </button>
                                    </td>
